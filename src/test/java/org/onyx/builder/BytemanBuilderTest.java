...
public class BytemanBuilderTest {
    ...
    public void testDirectoryDoesNotExist() throws IOException, DirectoryException, URISyntaxException {
    ...
    @Test(expected = DirectoryException.class)
    public void testInputIsNotDirectory() throws IOException, DirectoryException, URISyntaxException {
